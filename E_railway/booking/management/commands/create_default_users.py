...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        users = [
            ...
            {'username': 'passenger', 'password': 'passenger123', 'email': 'passenger@gmail.com', 'role': 'passenger'},
            {'username': 'maintenance', 'password': 'maintenance123', 'email': 'maintenance@gmail.com', 'role': 'maintenance'},
            {'username': 'employer', 'password': 'employer123', 'email': 'employer@gmail.com', 'role': 'employer'},
